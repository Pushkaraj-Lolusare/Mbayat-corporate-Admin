        ...
        <Block className="nk-block-middle nk-auth-body  wide-xs">
          <div className="brand-logo pb-4 text-center">
            <Link to={process.env.PUBLIC_URL + "/"} className="logo-link">
              ...
              <h1 style={{ fontSize: '35px', fontWeight: "500", marginTop:"20px"}}>Mbayat Corporate Panel</h1>
            </Link>
          </div>
          ...
          <PreviewCard className="card-bordered" bodyClass="card-inner-lg">
            ...
            <Form className="is-alter" onSubmit={handleLogin}>
              ...
              <div className="form-group">
                <Button size="lg" className="btn-block" type="submit" style={{color:"white", backgroundColor:"rgb(74,27,69)" }}>
